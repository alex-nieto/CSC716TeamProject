...
private:
   ...
   EventType eventType; // event type defines the type of event arrival completed or preemptive
    int remaningTime;
...
public:
    ...
    Event(int time, Process process, string newState, string oldState, int remaingTime, EventType eventType);
